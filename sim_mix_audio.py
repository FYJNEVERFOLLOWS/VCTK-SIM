...
for file_path in file_path_lst:
    ...
    while feat_seg_idx * SEG_HOP + SEG_LEN < sig.shape[1] // 2:
        ...
        stft_seg_level = tools.extract_stft_real_image(sig, fs, feat_seg_idx)
        ...
        # print("sample_data's feat.shape {}".format(sample_data["stft_seg_level"].shape), flush=True) # (8, 7, 337)
